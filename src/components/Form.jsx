...
function Form() {
  ...
  useEffect(() => {
    ...
    async function fetchCityData() {
      try {
        ...
        // Error handler - If there is no countryCode because a city was not clicked
        if (!data.countryCode)
          throw new Error(
        ...
        // Convert country code into an emoji
  ...
  // If no lat or lng the form will display this message
  ...
  return (
    // isLoading - when the form is submitted and the new city is being created
    <form
